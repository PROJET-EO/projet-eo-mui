  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position='static' sx={{ backgroundColor: heiColor.blue }}>
        <Toolbar>
          <IconButton size='large' edge='start' color='inherit' aria-label='open drawer' sx={{ mr: 2, color: heiColor.yellow }}>
            <MenuIcon />
          </IconButton>
          <Typography variant='h6' noWrap component='div' sx={{ display: { xs: 'none', sm: 'block', color: heiColor.yellow } }}>
            PROJET_EO
          </Typography>
          <Search>
            <SearchIconWrapper>
